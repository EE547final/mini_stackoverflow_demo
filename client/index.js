...
require('./server/routes/index.js')(app); // 必须在主文件中引入route
// const app = require("./app");
const mongoose = require("mongoose");
const PORT = process.env.PORT || 8080; 
const DB_URL = process.env.DATABASE_URL || 'mongodb+srv://user_1:user_1@zydb.j6fkc.mongodb.net/stackoverflow?retryWrites=true'; 
